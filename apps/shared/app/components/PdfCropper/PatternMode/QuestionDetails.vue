...
type Fields = ReturnType<typeof usePatternModeFormStore>['r$']['subjects']['$each'][number]['sections']['$each'][number]['questions']['details']
...
<template>
  ...
  >
    ...
    <UiCardContent class="flex flex-col items-center w-2xs px-3 gap-3">
      <FormLabel
        v-slot="{ id }"
        label="Question Type"
        :field="fields.type"
