...
const testConfig = defineModel<PdfCropperJsonOutput['testConfig']>(
  'testConfig',
  { required: true },
)
  ...
  <div class="flex flex-col grow min-h-0">
    ...
    >
        ...
        >
          <div class="flex flex-col items-center">
            ...
            <CbtMakerPdfCropperPatternModeSidePanel
              ...
              v-model:additional-data="testConfig.additionalData"
      ...
      >
        ...
        <div
          v-show="pdfLoadingState.isLoaded && currentMode === 'crop' && cropperMode.isPattern"
