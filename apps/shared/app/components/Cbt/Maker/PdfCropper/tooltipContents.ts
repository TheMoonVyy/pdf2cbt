...
export const splitPageWhenSubjectIsFound = () => h('div', { class: 'space-y-2' }, [
  h('p', [
    'This option is mainly for PDFs having multiple columns. ',
    'Consider a pdf having a formats like this:',
    h('br'),
    h('br'),
    'Format case 1 (two columns, upper part of both columns belongs to ',
    'current subject while lower belongs to new subject): ',
    h('br'),
    h('br'),
    'PHYSICS',
    h('br'),
    ...
    'Q2... | Q4...',
    h('br'),
    'CHEMISTRY (i.e start of new subject)',
    h('br'),
    'Q5... | Q6...',
    h('br'),
    'Q7... | Q8...',
    h('br'),
    'Here Q1, 2, 3, 4 belong to Physics, while the remaining belongs to chemistry.',
    h('br'),
    h('br'),
    'Now consider Format case 2',
    h('br'),
    h('br'),
    'PHYSICS',
    h('br'),
    ...
    'Q4... | Q8...',
    h('br'),
    'Here Q1, 2 belong to Physics, while the remaining belongs to chemistry.',
  ]),

  h('ul', { class: 'list-disc space-y-1 ml-6 [&>li]:mb-1' }, [
    h('li', [
      h('strong', 'When Enabled (works on format case 1)'),
      ': When new subject is found, the tool splits the page ',
      'horizontally at that point into 2 parts (upper and lower). ',
      'The tool treats upper part to belong to current subject while the lower part belongs to the new subject.',
    ]),
    h('li', [
      h('strong', 'When Disabled (works on format case 2)'),
      ': The tool will not split the page horizontally when new subject is found. ',
      'In column 1, it will start searching from top to bottom of the page. ',
      'Then it will move to column 2 and again search from top to bottom of the page and so on...',
      h('br'),
      'This is how the Pattern based cropper was working before v2.6.0 ',
      '(in v2.6.0 this option to choose between the two approaches was added).',
    ]),
  ]),
])
