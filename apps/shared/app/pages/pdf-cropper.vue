    ...
    >
      ...
      >
        ...
        <PdfCropperPatternModeMainPanel
          ...
          :pdf-pages-pattern-mode-data="patternModeState.pdfPagesPatternModeData"
...
async function loadPdfPatternModeData(
  ...
  patternModeState.pdfPagesPatternModeData = await mupdfWorker.getPdfTextData(pageNums, options)
}
