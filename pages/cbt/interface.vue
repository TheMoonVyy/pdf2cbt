...
import '~/src/assets/css/cbt-interface.css'
import ProgressBar from '~/src/volt/ProgressBar.vue'
import answeredIcon from '~/src/assets/icons/ques-answered.svg?no-inline'
import notAnsweredIcon from '~/src/assets/icons/ques-notAnswered.svg?no-inline'
import notVisitedIcon from '~/src/assets/icons/ques-notVisited.svg?no-inline'
import markedIcon from '~/src/assets/icons/ques-marked.svg?no-inline'
import markedAnsweredIcon from '~/src/assets/icons/ques-markedAnswered.svg?no-inline'
import profileIcon from '~/src/assets/icons/profile.svg?no-inline'
...
function generateTestOutputData() {
  ...
  for (const sectionItem of testSectionsList.value) {
    const { subject, name: section } = sectionItem
